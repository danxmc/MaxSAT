...
public class Dpll {
     ...
     * @return
     */
    private static DpllResult solve(Formula formula, HashMap<String, Boolean> variableSetting, int orderSize,
            int tabs) {
        log(tabs, "Solving formula with " + formula.getClauses().size() + " clauses and "
                + formula.getLiteralsLex().size() + " literals:");
